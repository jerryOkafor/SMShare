...
data class AuthPayload(val accessToken: String? = null, val user: User? = null)

class LoginMutationService(userService: DefaultUserRepository, private val authUtil: AuthUtil) :
    Mutation {
