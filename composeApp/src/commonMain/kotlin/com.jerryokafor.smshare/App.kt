...
import com.jerryokafor.smshare.component.SideNav
import com.jerryokafor.smshare.component.SideNavMenuAction
...
fun App(
    ...
    KoinContext {
        ...
        val appState: AppState = rememberAppState(navController, viewModel)
...
fun Home(
                ...
                ModalBottomSheetLayout(
                    ...
                    content = {
                        Scaffold(
                            ...
                            topBar = {
                                if (isLoggedIn) {
                                    topAppBarState?.let { appBarState ->
                                        CenterAlignedTopAppBar(
                                            title = {
                                                appBarState.title?.invoke()
                                            },
                                            actions = {
    ...
    LaunchedEffect(userData) {
        if (userData is AppUiState.Success) {
            currentAnAppReady()
            if ((userData as AppUiState.Success).user.isLoggedIn) {
                navController.navigateToPosts()
            } else {
                navController.navigateToSignIn()
            }
